...
setRegister = (event) => {
  ...
  render() {
    ...
    <Container maxWidth="sm" className={classes.root}>
            ...
            <p style={{margin: '5% 0', textAlign: 'center'}}>Wprowadź adres <span style={{fontWeight:'600'}}>e-mail </span>, aby zresetować <span style={{fontWeight:'600'}}> hasło </span>do swojego <span style={{fontWeight:'600'}}> konta</span>.</p>
          ...
          <p style={{margin: '5% 0', textAlign: 'center', fontWeight: '600'}}>{this.state.text}</p>
